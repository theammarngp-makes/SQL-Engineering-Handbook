...
> [!NOTE]
> Mode Analytics was acquired by ThoughtSpot; its SQL tutorial content has migrated under the ThoughtSpot brand. If you find an old `mode.com` link elsewhere, expect a redirect.

---

*Next: [`datasets.md`](datasets.md). Back to [Resources Library](README.md).*
